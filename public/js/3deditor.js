...
var sceneid_g = []
var currId = ""
const previewAdded =` <div id="PropertiesPreview" class="tab-content">
<div class="tab-pane active" id="home1Icon" aria-labelledby="home1Icon-tab"
    ...
    <div style="padding-bottom: -15px;" id="properties_value">
        ...
        <div class="row">
                                <div class="col-4"><div class="open-buttonrt " id="close-buttonrt" onclick="closeNavrt()">
                                ...
                                <div class="col-4 mt-1" id="propertiesText">Properties</div>
                            </div>
        
        <p id="componenttext">component</p>
...
console.log("test loremli",ul.id)
        ...
        //                                         </svg>
        // </div>`
        if(!document.getElementById('PropertiesPreview'))
        {
