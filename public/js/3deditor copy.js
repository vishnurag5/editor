...
function addScene() {
    ...
    */
    ...
    document.getElementById('new_scenes_list').innerHTML = scene_present + '<div style="display: flex;flex-direction: row; justify-content: centre;"><ul class="scrollers" id=' + ul_id + ' onclick="get_scene(this.id)"  style="color: white;"> <li id="scroller"><div style="display: flex;flex-direction: row; justify-content: space-between;"><span id=' + "li-" + rec_id + ' class="scene" onclick="shownewscene(' + "'" + rec_id + "', " + "'" + elements_tag + "'" + ')"><img src="../../../app-assets//images/svg/Vector (9).png" style="margin-right: 10px;">' + rec_id + '</span> <div> <img id=' + select_id + ' onclick="setid(this.id)" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom2" aria-controls="offcanvasBottom2" src="../../../app-assets//images/svg/Vector(8).png" style="margin-right: 5px;height: 12px; width: 12px;"> </div></div>  <div style="display: flex;justify-content: space-between;padding-left: 40px;padding-top: 5px;padding-bottom: 3px;"> </div><ul id=' + elements_tag + ' class="nested active"></ul></li></ul><img onclick="lockscene(\'' +ul_id + '\')"src="../../../app-assets//images/svg/lock-alt.svg" alt="" height="20" width="20"><img  src="app-assets//images/svg/renamefolder.svg" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"></div><br />'
