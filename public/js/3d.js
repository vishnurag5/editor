    ...
    for (i = 0; i <= sceneid_g.length; i++) {
        if (sceneid_g[i] == id) {
            document.getElementById(sceneid_g[i]).style.backgroundColor = "red"
                ...
                document.getElementById(sceneid_g[i]).style.backgroundColor = "#283046"
...
function componentsHighlight(id) {
    ...
    for (i = 0; i <= component_id.length; i++) {
        if (component_id[i] == id) {
            currId = id
            document.getElementById(component_id[i]).style.backgroundColor = "pink"
        } else {
            
                document.getElementById(component_id[i]).style.backgroundColor = "#283046"
...
function addScene() {
    ...
    */
    ...
    document.getElementById('new_scenes_list').innerHTML = scene_present + '<ul class="scrollers" id=' + ul_id + ' onclick="get_scene(this.id)"  style="color: white;"> <li id="scroller"><div style="display: flex;flex-direction: row; justify-content: space-between;"><span id=' + "li-" + rec_id + ' class="scene" onclick="shownewscene(' + "'" + rec_id + "', " + "'" + elements_tag + "'" + ')"><img src="../../../app-assets//images/svg/Vector (9).png" style="margin-right: 10px;">' + rec_id + '</span> <div> <img id=' + select_id + ' onclick="setid(this.id)" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom2" aria-controls="offcanvasBottom2" src="../../../app-assets//images/svg/Vector(8).png" style="margin-right: 5px;height: 12px; width: 12px;"> <img onclick="" class="" src="../../../app-assets//images/svg/lock-alt.svg" alt="" height="20" width="20"></div></div>  <div style="display: flex;justify-content: space-between;padding-left: 40px;padding-top: 5px;padding-bottom: 3px;"> </div><ul id=' + elements_tag + ' class="nested active"></ul></li></ul><br />'
...
function hideshow(id){
    console.log("getting the id for hide and show",id)
    alert("hide")
    $('#'+scene_id).toggle('hide');
}
...
function add_images(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd, id_recd) {
    ...
    if (position_recd == "center") {
        ...
        console.log("main scene", sceneEl)
        var entity_img = document.createElement('a-image');
        entity_img.setAttribute('id', "image_added" + scene_id + newcompoCounter)
        entity_img.setAttribute('src', "https://www.rhibhus.com/AR_Trial/metabild/editor/Placeholders_3deditor/Image_place%20holder.png")
        // entity_img.setAttribute('scale', { x: 2, y: 2, z: 2 })
        // entity_gltf.setAttribute('rotation',{x:180 , y:90 ,z:180})
        console.log("Image Properties::", entity_img.object3D.position.x);
        ...
        eyeicon.setAttribute('onclick', 'hideshow(\'' + entity_img.id + '\')');
        ...
        li.addEventListener('click', function (e) {
            ...
            scaling_saved = scaling_recd
            source_saved = source_recd
            selected_object_id = "image_added" + scene_id + newcompoCounter
            cut_element = li.id;
            console.log("onlcick of", selected_object_id)
              //ashwin's code
...
function add_video(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd,id_recd) {
    if (position_recd == "center") {
        ...
        var entity_video = document.createElement('a-video');
        var newcompoCounter = Math.floor((Math.random() * 1000) + 1);
        entity_video.setAttribute('id', "video_added" + scene_id + newcompoCounter)
        // entity_video.setAttribute('position', { x: 0, y: 1, z: -3 });
        entity_video.setAttribute('src', "https://www.rhibhus.com/AR_Trial/metabild/editor/Placeholders_3deditor/Video_place%20holder.png")
        // entity_video.setAttribute('width', 8)
        // entity_video.setAttribute('height', 5)
        ...
        li.addEventListener('click', function (e) {
            ...
            scaling_saved = scaling_recd
            source_saved = source_recd
            selected_object_id = "video_added" + scene_id +newcompoCounter
            console.log("onlcick of", li.id)
              //ashwin's code
              component_id.push(li.id)
              console.log(component_id)
...
function add_text(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd) {
    
    
    if (position_recd == "center") {
        // var sceneEl = document.querySelector('a-scene');
        var sceneEl = document.getElementById(scene_id)
        var entity_text = document.createElement('a-entity');
        entity_text.setAttribute('id', "text" + scene_id)
        ...
        li.addEventListener('click', function (e) {
            ...
            scaling_saved = scaling_recd
            cut_element = li.id;
            selected_object_id = "torus" + scene_id
            console.log("onlcick of", li.id)
              //ashwin's code
              component_id.push(li.id)
              console.log(component_id)
        ...
        var sceneEl = document.getElementById(scene_id)
        var entity_text = document.createElement('a-entity');
        entity_text.setAttribute('id', "torus" + scene_id)
        ...
        li.addEventListener('click', function (e) {
            ...
            source_saved = source_recd
            cut_element = li.id;
            selected_object_id = "text" + scene_id
            console.log("onlcick of", li.id)
              //ashwin's code
              component_id.push(li.id)
              console.log(component_id)
...
function add_cube(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd,id_recd) {
    if (position_recd == "center") {
        ...
        // entity_cube.className="draggable"
        var newcompoCounter = Math.floor((Math.random() * 1000) + 1);
        entity_cube.setAttribute('id', "cube" + scene_id +newcompoCounter)
        ...
        li.addEventListener('click', function (e) {
            ...
            scaling_saved = scaling_recd
            source_saved = source_recd
            selected_object_id = "cube" + scene_id+newcompoCounter
            //ashwin's code
            component_id.push(li.id)
            console.log(component_id)
            componentsHighlight(li.id)
...
function changeModel(modellink, id, scene_id, position_recd, scaling_recd, rotation_recd, source_recd,id_recd) {
    ...
    if (position_recd == "center") {
        ...
        console.log(data_arr)
        var newcompoCounter = Math.floor((Math.random() * 1000) + 1);
        entity_gltf.setAttribute('id', "model" + scene_id + newcompoCounter)
        ...
        li.addEventListener('click', function (e) {
            ...
            source_saved = modellink
            cut_element = li.id;
            selected_object_id = "model" + scene_id +newcompoCounter
            console.log("onlcick of", li.id)
              //ashwin's code
              component_id.push(li.id)
              console.log(component_id)
...
// function add_torus(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd) {

//     if (position_recd == "center") {
//         // var sceneEl = document.querySelector('a-scene');
//         var sceneEl = document.getElementById(scene_id)
//         var entity_gltftorus = document.createElement('a-entity');
//         entity_gltftorus.setAttribute('id', "torus" + scene_id)
//         entity_gltftorus.setAttribute('position', { x: 0, y: 0, z: -1 });
//         entity_gltftorus.setAttribute('geometry', "primitive: torus; radius: 2; radiusTubular: 0.5; arc: 180")
...
//             source_saved = source_recd
//             selected_object = entity_gltftorus.object3D
//             console.log("clicked image", entity_gltftorus)
//             document.getElementById('object_name').innerText = data_arr[0]
//             selected_object_id = data_arr[0]
//             var inputX = document.getElementById("translateX");
//             inputX.setAttribute('value', entity_gltftorus.object3D.position.x)
...
function add_torus(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd,id_recd) {
    ...
    if (position_recd == "center") {
        ...
        var newcompoCounter = Math.floor((Math.random() * 1000) + 1);
        entity_gltftorus.setAttribute('id', "torus" + scene_id +newcompoCounter)
        entity_gltftorus.setAttribute('position', { x: 0, y: 0, z: -1 });
        ...
        li.addEventListener('click', function (e) {
            ...
            scaling_saved = scaling_recd
            cut_element = li.id;
            selected_object_id = "torus" + scene_id +newcompoCounter
            console.log("onlcick of", li.id)
              //ashwin's code
              component_id.push(li.id)
              console.log(component_id)
...
function add_torus1(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd) {

    if (position_recd == "center") {
        // var sceneEl = document.querySelector('a-scene');
        var sceneEl = document.getElementById(scene_id)
        var entity_gltftorus = document.createElement('a-torus');
        entity_gltftorus.setAttribute('id', scene_id)
        entity_gltftorus.setAttribute('position', { x: 0, y: 0, z: -1 });
        entity_gltftorus.setAttribute('radius', 2)
        entity_gltftorus.setAttribute('radiusTubular', 0.5)
        entity_gltftorus.setAttribute('arc', 180)
...
// function add_light(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd) {

//     if (position_recd == "center") {
//         // var sceneEl = document.querySelector('a-scene');
//         var sceneEl = document.getElementById(scene_id)
//         var entity_light = document.createElement('a-entity');
//         entity_light.setAttribute('id', "light" + scene_id)
//         entity_light.setAttribute('position', { x: 0, y: 0, z: 0 });
//         entity_light.setAttribute('light', "color: #AFA; intensity: 1.5")
...
//             scaling_saved = scaling_recd
//             cut_element = li.id;
//             selected_object_id = "light" + scene_id
//             console.log("onlcick of", li.id)
//             var findobject = document.getElementById(selected_object_id)
//             console.log("found,", findobject.object3D)
//             selected_object = findobject.object3D
...
//             scaling_saved = scaling_recd
//             source_saved = source_recd
//             selected_object = entity_light.object3D
//             console.log("clicked image", entity_light.object3D)
//             document.getElementById('object_name').innerText = data_arr[0]
//             selected_object_id = data_arr[0]
//             var inputX = document.getElementById("translateX");
//             inputX.setAttribute('value', entity_light.object3D.position.x)
//             var inputY = document.getElementById("translateY");
//             inputY.setAttribute('value', entity_light.object3D.position.y)
//             var inputZ = document.getElementById("translateZ");
//             inputZ.setAttribute('value', entity_light.object3D.position.z)
//             var inputX = document.getElementById("rotateX");
//             inputX.setAttribute('value', entity_light.object3D.rotation.x)
//             var inputY = document.getElementById("rotateY");
//             inputY.setAttribute('value', entity_light.object3D.rotation.y)
//             var inputZ = document.getElementById("rotateZ");
//             inputZ.setAttribute('value', entity_light.object3D.rotation.z)
//             var inputX = document.getElementById("scaleX");
//             inputX.setAttribute('value', entity_light.object3D.scale.x)
//             var inputY = document.getElementById("scaleY");
//             inputY.setAttribute('value', entity_light.object3D.scale.y)
//             var inputZ = document.getElementById("scaleZ");
//             inputZ.setAttribute('value', entity_light.object3D.scale.z)
//             // openProperties();
//         });
//         // entity_gltf.setAttribute('rotation',{x:180 , y:90 ,z:180})
//         console.log("Model Properties::", entity_light.object3D);
...
//         var sceneEl = document.getElementById(scene_id)
//         var entity_light = document.createElement('a-entity');
//         entity_light.setAttribute('id', "torus" + scene_id)
//         entity_light.setAttribute('position', { x: position_recd.position.x, y: position_recd.position.y, z: position_recd.position.z });
//         entity_light.setAttribute('light', "type: ambient; color: #CCC")
//         entity_light.setAttribute('scale', { x: scaling_recd.scale.x, y: scaling_recd.scale.y, z: scaling_recd.scale.z })
//         entity_light.setAttribute('rotation', { x: THREE.Math.radToDeg(rotation_recd.rotation._x), y: THREE.Math.radToDeg(rotation_recd.rotation._y), z: THREE.Math.radToDeg(rotation_recd.rotation._z) });
//         //add it to structure
//         var ul = document.getElementById(id + "_elements");
//         var li = document.createElement("li");
//         var newImage = document.createElement('img')
...
//             source_saved = source_recd
//             selected_object = entity_light.object3D
//             console.log("clicked image", entity_light)
//             document.getElementById('object_name').innerText = data_arr[0]
//             selected_object_id = data_arr[0]
//             var inputX = document.getElementById("translateX");
//             inputX.setAttribute('value', entity_light.object3D.position.x)
...
// }
// function add_sound(id,scene_id)
// {
//    var samplemp3= "https://www.rhibhus.com/AR_Trial/metabild/editor/Placeholders_3deditor/sample.mp3"
//    console.log("selected id",selected_object,selected_object_id)
//    var mainscene = document.getElementById('mainScene')
//    var a_assets = document.createElement('a-assets');
//    var audio = document.createElement('audio');
//    audio.setAttribute('src', samplemp3)
//    audio.setAttribute('id',"espressoMachine")
//    a_assets.appendChild(audio)
//    mainscene.appendChild(a_assets)
//    var sceneEl = document.getElementById(scene_id)
//    var findobject_sound = document.getElementById(selected_object_id)
//    var src_string = "src:"+audio.id+";volume: 1; autoplay:true"
//    findobject_sound.setAttribute ('sound',src_string)
   
//    sceneEl.appendChild(findobject_sound)
// }
function add_light(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd,id_recd) {
    ...
    if (position_recd == "center") {
        ...
        var newcompoCounter = Math.floor((Math.random() * 1000) + 1);
        entity_light.setAttribute('id', "light" + scene_id+newcompoCounter)
        ...
        li.addEventListener('click', function (e) {
            ...
            scaling_saved = scaling_recd
            cut_element = li.id;
            selected_object_id = "light" + scene_id+newcompoCounter
            console.log("onlcick of", li.id)
              //ashwin's code
              component_id.push(li.id)
              console.log(component_id)
...
function add_light1(id, scene_id, position_recd, rotation_recd, scaling_recd, source_recd) {

    if (position_recd == "center") {
        // var sceneEl = document.querySelector('a-scene');
        var sceneEl = document.getElementById(scene_id)
        var entity_light = document.createElement('a-light');
        entity_light.setAttribute('id',  scene_id)
        // entity_light.setAttribute('geometry',"primitive: cylinder");
        entity_light.setAttribute('gltf-model', "url(https://www.rhibhus.com/AR_Trial/metabild/editor/realistic_light_bulb__low_poly/scene.gltf)")
        entity_light.setAttribute('position', { x: 0, y: 1, z: 0 })
        entity_light.setAttribute('scale', { x: 0.2, y: 0.2, z: 0.2 })
...
function add_sound(id, scene_id) {
    ...
    var newcompoCounter = Math.floor((Math.random() * 1000) + 1);
    entity_sound.setAttribute('id', "sound" + scene_id +newcompoCounter)
    ...
    li.addEventListener('click', function (e) {
        ...
        cut_element = li.id;
        selected_object_id = "sound" + scene_id+newcompoCounter
    ...
    newcompoCounter=newcompoCounter+1

}
function add_sound1(id, scene_id) {
    var samplemp3 = "https://www.rhibhus.com/AR_Trial/metabild/editor/Placeholders_3deditor/sample.mp3";
    var soundsrc = "src: url(" + samplemp3 + "); autoplay: true"
    var sceneEl = document.getElementById(scene_id)
    var entity_sound = document.createElement('a-sound');
    entity_sound.setAttribute('id',  scene_id)
    entity_sound.setAttribute('gltf-model', "url(https://www.rhibhus.com/AR_Trial/metabild/editor/mid_frequency_speaker/scene.gltf)")
    entity_sound.setAttribute('scale', { x: 0.002, y: 0.002, z: 0.002 })
    entity_sound.setAttribute('src', samplemp3)
    entity_sound.setAttribute('autoplay', true)
            ...
            function ScenesLoop(i) {
                if (i < total_num_of_scenes) {
                    ...
                    if (newscene_name !== "scene1") {
                        ...
                        var select_id = "s" + (i + 1) + "-" + newscene_name;
                        var scene_present = document.getElementById('new_scenes_list').innerHTML;
                        document.getElementById('new_scenes_list').innerHTML = scene_present + '<ul id=' + ul_id + '  onclick="get_scene(this.id)" style="color: white;"> <li><div style="display: flex;flex-direction: row; justify-content: space-between;"><span id=' + newscene_name + ' class="scene" onclick="shownewscene(' + "'" + newscene_name + "', " + "'" + elements_tag + "'" + ')"><img src="../../../app-assets//images/svg/Vector (9).png" style="margin-right: 10px;">' + newscene_name + '</span> <div> <img id=' + select_id + ' onclick="setid(this.id)" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom" src="../../../app-assets//images/svg/Vector(8).png" style="margin-right: 5px;height: 12px; width: 12px;"> <img onclick="" class="" src="../../../app-assets//images/svg/lock-alt.svg" alt="" height="20" width="20"></div></div>  <div style="display: flex;justify-content: space-between;padding-left: 40px;padding-top: 5px;padding-bottom: 3px;"> </div><ul id=' + elements_tag + ' class="nested active"></ul></li></ul><br />'
